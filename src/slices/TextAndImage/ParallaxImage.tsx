...
export function ParallaxImage({
  ...
  useEffect(() => {
    ...
    function onMouseMove(event: MouseEvent) {
      const { innerWidth, innerHeight } = window; // destructuring the browser's width and height from window
      const xPercent = (event.clientX / innerWidth - 0.5) * 2; // this is give us range within -1 and 1
      const yPercent = (event.clientY / innerHeight - 0.5) * 2; // this is give us range within -1 and 1
