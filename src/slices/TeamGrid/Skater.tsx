    ...
    <div className="skater group relative flex flex-col items-center gap-4">
      <div className="stack-layout overflow-hidden">
        <PrismicNextImage
          ...
          width={500}
          imgixParams={{ q: 20 }} // reducing the quality of background image as it doesn't matter much
          alt=""
        ...
        <h3 className="relative grid place-self-end justify-self-center p-2 font-chicle text-brand-gray text-2xl md:text-3xl">
