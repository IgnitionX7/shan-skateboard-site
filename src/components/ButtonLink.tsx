  ...
  return (
    <PrismicNextLink
      className={clsx(
        ...
        size === "md" && "gap-3 px-1 py-2.5 text-lg",
        size === "lg" &&
          "gap-3 sm:gap-3.5 md:gap-4 px-1 sm:px-1.5 md:px-2 py-3 sm:py-3.5 md:py-4 text-lg sm:text-xl md:text-2xl",
        color === "orange" &&
        ...
        <>
          <div
            className={clsx(
              ...
              size === "sm" && "size-5",
              size === "md" && "size-6",
              size === "lg" && "size-6 sm:size-7 md:size-8"
            )}
          >
