...
export function Skateboard({
  ...
  const boltMaterial = useMemo(
    () =>
      new THREE.MeshStandardMaterial({
        color: boltColor,
        metalness: 0.5,
        roughness: 0.3, // lower values means more shiny
      }),
    [boltColor]
  );
  ...
  const truckMaterial = useMemo(
    () =>
      new THREE.MeshStandardMaterial({
        ...
        metalness: 0.8,
        roughness: 0.25, // lower values means more shiny
      }),
  ...
  const deckMaterial = useMemo(
    () =>
      new THREE.MeshStandardMaterial({
        map: deckTexture,
        roughness: 0.1, // lower values means more shiny
      }),
    [deckTexture]
  );
  ...
  const wheelMaterial = useMemo(
    () =>
      new THREE.MeshStandardMaterial({
        map: wheelTexture,
        roughness: 0.35, // lower values means more shiny
      }),
    [wheelTexture]
  );
